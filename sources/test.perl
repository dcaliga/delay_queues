...
@entire_set = (
    "v1",             "ex_delay_queues", "../../pictures/train.pgm",
    "v1_solution_1",  "ex_delay_queues", "../../pictures/train.pgm",
    "v1_solution_2",  "ex_delay_queues", "../../pictures/train.pgm",
    "v1_solution_3",  "ex_delay_queues", "../../pictures/train.pgm",
    "v1_solution_4",  "ex_delay_queues", "../../pictures/train.pgm",
    "v1_solution_5",  "ex_delay_queues", "../../pictures/train.pgm",
    "v1_solution_6",  "ex_delay_queues", "../../pictures/train.pgm",
     );
